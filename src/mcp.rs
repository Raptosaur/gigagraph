        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "kind": { "type": "string", "description": "Filter: http, soap, xml-rpc, json-rpc, or grpc." },
                    "limit": { "type": "integer" }
                }
            }
        },
